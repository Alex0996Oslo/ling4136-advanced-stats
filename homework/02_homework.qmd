...
### (D) Optional: Consistency of effect 
If you have not done `01_exercises`, plot how consistent the effect is across different participants. If you have done the prior exercise, remind yourself on it here and take it into consideration when reporting your (sub-optimal) model.

```{r}
#| label: consistency_quantese
